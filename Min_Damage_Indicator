...
local Menu = {
    ...
    checkbox = ui.new_checkbox("RAGE", "Aimbot", "Rainbow Minimum Damage Indicator"), -- MEME for our indicators to get rainbow look
...
Damage_Indi = function()
    ...
    local indicator = ui.get(Menu.checkbox) -- check if you toggled it
